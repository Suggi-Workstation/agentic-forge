# forge-index -- Search agentic-forge

Hybrid file retrieval over the `agentic-forge` repository. It combines
...
Run from `/srv/forge/agentic-forge`:
...
Index data lives in `~/.forge-index` (`/srv/forge/index` on the VPS), outside
